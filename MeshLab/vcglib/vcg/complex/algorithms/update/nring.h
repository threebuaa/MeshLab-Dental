...
*                                                                           *
****************************************************************************/
#ifndef RINGWALKER_UPDATE_H
#define RINGWALKER_UPDATE_H
    ...
    namespace tri
    {
        ...
        */
        ...
        public:
            ...
            MeshType* m;
            UpdateNring(VertexType* v, MeshType* m) : m(m)
            {
            ...
            void insertAndFlag(FaceType* f, VertexType* v)
            {
                if (!f->IsV())
                {
                    allF.push_back(f);
                    ...
                    //deal with special case that makes the first face appear to be clockwise
                    if(f->V(1) == v) {
						//change the order you send them in (send them in counterclockwise)                            
						insertAndFlag(f->V(2));
						insertAndFlag(f->V(0));
						insertAndFlag(f->V(1));                        
                    }
